...
import { PanelBody, SelectControl, Placeholder, Button } from '@wordpress/components';
...
export default function Edit( { attributes, setAttributes, context } ) {
	...
	const settingsUrl = ( window.RoxyAPIEditor && window.RoxyAPIEditor.settingsUrl ) || '#';
		...
		return (
			<div { ...blockProps }>
				<Placeholder
					...
					instructions={ __( 'Add your RoxyAPI key in Settings to use this block.', 'roxyapi' ) }
				>
	...
	const effectiveSign = attributes.sign || ( context && context[ 'roxyapi/sign' ] ) || 'aries';
