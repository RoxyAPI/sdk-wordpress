...
const fields = [
	...
	},
	{
		...
		required: false,
		help: __( 'House system used to place the Sun, which determines the chart sect (day when the Sun is above the horizon, night when below) and therefore which lot formula applies', 'roxyapi' ),
