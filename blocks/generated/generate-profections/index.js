...
const fields = [
	...
	},
	{
		...
		required: true,
		help: __( 'Date whose profection year you want, in YYYY-MM-DD format', 'roxyapi' ),
	},
	{
		name: 'houseSystem',
		control: 'select',
		...
		required: false,
		help: __( 'House system used only to report where the lord of the year sits in the natal chart', 'roxyapi' ),
