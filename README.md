<p align="center">
  <a href="https://roxyapi.com">
    <img src="https://raw.githubusercontent.com/RoxyAPI/sdk-wordpress/main/assets/hero.png" alt="RoxyAPI WordPress plugin, blocks and shortcodes. The Spiritual OS layer for agentic AI. One key, flat pricing. Server side rendering." width="100%">
  </a>
</p>
...
The **Astrology Section** wrapper block sets a default zodiac sign for the Horoscope blocks placed inside it, so one setting drives several horoscopes on a page.
...
-   **Interface translation, not only the readings.** Text domain `roxyapi`. Ships built in catalogues for German, Spanish, Hindi, Turkish, Portuguese, French and Russian, covering the settings screens, the birth details form, and every message a visitor reads.
