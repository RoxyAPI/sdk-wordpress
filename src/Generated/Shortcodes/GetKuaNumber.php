<?php
/**
 * Auto-generated shortcode: [roxy_get_kua_number]
 *
...
class GetKuaNumber {
	...
	public const TAG = 'roxy_get_kua_number';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::getKuaNumber( $atts['number'], $atts['lang'] );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render_atts( 'getKuaNumber', is_array( $data ) ? $data : array(), $atts );
	}
}
