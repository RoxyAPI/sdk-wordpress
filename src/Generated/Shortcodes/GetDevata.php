<?php
/**
 * Auto-generated shortcode: [roxy_get_devata]
 *
...
class GetDevata {
	...
	public const TAG = 'roxy_get_devata';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::getDevata( $atts['id'], $atts['lang'] );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render_atts( 'getDevata', is_array( $data ) ? $data : array(), $atts );
	}
}
