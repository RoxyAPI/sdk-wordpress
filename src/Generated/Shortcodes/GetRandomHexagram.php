<?php
/**
 * Auto-generated shortcode: [roxy_get_random_hexagram]
 *
...
class GetRandomHexagram {

	public const TAG = 'roxy_get_random_hexagram';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::getRandomHexagram( $atts['lang'] );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render( 'getRandomHexagram', is_array( $data ) ? $data : array(), $atts['hide_readings'], $atts['hide_sections'] );
	}
}
