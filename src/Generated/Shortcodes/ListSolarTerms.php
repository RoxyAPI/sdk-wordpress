<?php
/**
 * Auto-generated shortcode: [roxy_list_solar_terms]
 *
...
class ListSolarTerms {

	public const TAG = 'roxy_list_solar_terms';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::listSolarTerms( $atts['year'], $atts['lang'] );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render_atts( 'listSolarTerms', is_array( $data ) ? $data : array(), $atts );
	}
}
