<?php
/**
 * Auto-generated shortcode: [roxy_calculate_mayan_compatibility]
 *
...
class CalculateMayanCompatibility {

	public const TAG = 'roxy_calculate_mayan_compatibility';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		return FormRenderer::render( \RoxyAPI\Generated\Forms\CalculateMayanCompatibilityForm::class, $atts );
	}
}
