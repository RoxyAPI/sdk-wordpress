<?php
/**
 * Auto-generated shortcode: [roxy_get_shem_name]
 *
...
class GetShemName {
	...
	public const TAG = 'roxy_get_shem_name';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::getShemName( $atts['number'], $atts['lang'] );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render_atts( 'getShemName', is_array( $data ) ? $data : array(), $atts );
	}
}
