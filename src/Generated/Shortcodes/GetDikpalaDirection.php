<?php
/**
 * Auto-generated shortcode: [roxy_get_dikpala_direction]
 *
...
class GetDikpalaDirection {

	public const TAG = 'roxy_get_dikpala_direction';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::getDikpalaDirection( $atts['id'], $atts['lang'] );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render_atts( 'getDikpalaDirection', is_array( $data ) ? $data : array(), $atts );
	}
}
