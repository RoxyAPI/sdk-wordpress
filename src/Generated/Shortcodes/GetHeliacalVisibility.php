<?php
/**
 * Auto-generated shortcode: [roxy_get_heliacal_visibility]
 *
...
class GetHeliacalVisibility {

	public const TAG = 'roxy_get_heliacal_visibility';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::getHeliacalVisibility( $body );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render( 'getHeliacalVisibility', is_array( $data ) ? $data : array(), $atts['hide_readings'], $atts['hide_sections'] );
	}
}
