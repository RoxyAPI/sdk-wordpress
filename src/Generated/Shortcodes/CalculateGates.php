<?php
/**
 * Auto-generated shortcode: [roxy_calculate_gates]
 *
...
class CalculateGates {

	public const TAG = 'roxy_calculate_gates';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::calculateGates( $body, $query );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render( 'calculateGates', is_array( $data ) ? $data : array(), $atts['hide_readings'] );
	}
}
