<?php
/**
 * Auto-generated shortcode: [roxy_get_daily_zodiac_reading]
 *
...
class GetDailyZodiacReading {

	public const TAG = 'roxy_get_daily_zodiac_reading';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::getDailyZodiacReading( $atts['id'], $atts['lang'], $atts['date'], $atts['timezone'] );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render_atts( 'getDailyZodiacReading', is_array( $data ) ? $data : array(), $atts );
	}
}
