<?php
/**
 * Auto-generated shortcode: [roxy_get_monthly_almanac]
 *
...
class GetMonthlyAlmanac {

	public const TAG = 'roxy_get_monthly_almanac';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::getMonthlyAlmanac( $atts['lang'], $atts['year'], $atts['month'] );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render_atts( 'getMonthlyAlmanac', is_array( $data ) ? $data : array(), $atts );
	}
}
