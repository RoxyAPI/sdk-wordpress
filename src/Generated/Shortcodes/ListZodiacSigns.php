<?php
/**
 * Auto-generated shortcode: [roxy_list_zodiac_signs]
 *
...
class ListZodiacSigns {

	public const TAG = 'roxy_list_zodiac_signs';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::listZodiacSigns( $atts['lang'] );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render( 'listZodiacSigns', is_array( $data ) ? $data : array(), $atts['hide_readings'] );
	}
}
