<?php
/**
 * Auto-generated shortcode: [roxy_generate_flying_star_chart]
 *
...
class GenerateFlyingStarChart {

	public const TAG = 'roxy_generate_flying_star_chart';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		wp_enqueue_style( 'roxyapi-frontend' );
				...
				$body = array_filter(
			array(
				'period' => $atts['period'] !== '' ? (int) $atts['period'] : '',
				'facing' => $atts['facing'],
				'facingDegrees' => $atts['facing_degrees'],
			),
			static function ( $v ) {
				return $v !== '';
			}
		...
		$data = \RoxyAPI\Generated\Client::generateFlyingStarChart( $body, $query );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render_atts( 'generateFlyingStarChart', is_array( $data ) ? $data : array(), $atts );
	}
}
