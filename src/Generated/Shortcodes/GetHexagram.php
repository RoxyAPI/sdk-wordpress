<?php
/**
 * Auto-generated shortcode: [roxy_get_hexagram]
 *
...
class GetHexagram {
	...
	public const TAG = 'roxy_get_hexagram';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::getHexagram( $atts['number'], $atts['lang'] );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render( 'getHexagram', is_array( $data ) ? $data : array(), $atts['hide_readings'], $atts['hide_sections'] );
	}
}
