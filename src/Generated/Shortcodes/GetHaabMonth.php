<?php
/**
 * Auto-generated shortcode: [roxy_get_haab_month]
 *
...
class GetHaabMonth {
	...
	public const TAG = 'roxy_get_haab_month';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::getHaabMonth( $atts['id'], $atts['lang'] );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render_atts( 'getHaabMonth', is_array( $data ) ? $data : array(), $atts );
	}
}
