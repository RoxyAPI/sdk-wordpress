<?php
/**
 * Auto-generated shortcode: [roxy_generate_transit]
 *
...
class GenerateTransit {

	public const TAG = 'roxy_generate_transit';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		return FormRenderer::render( \RoxyAPI\Generated\Forms\GenerateTransitForm::class, $atts );
	}
}
