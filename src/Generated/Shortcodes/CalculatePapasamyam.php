<?php
/**
 * Auto-generated shortcode: [roxy_calculate_papasamyam]
 *
...
class CalculatePapasamyam {

	public const TAG = 'roxy_calculate_papasamyam';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		return FormRenderer::render( \RoxyAPI\Generated\Forms\CalculatePapasamyamForm::class, $atts );
	}
}
