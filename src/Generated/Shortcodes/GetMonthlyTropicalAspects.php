<?php
/**
 * Auto-generated shortcode: [roxy_get_monthly_tropical_aspects]
 *
...
class GetMonthlyTropicalAspects {

	public const TAG = 'roxy_get_monthly_tropical_aspects';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::getMonthlyTropicalAspects( $body, $query );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render_atts( 'getMonthlyTropicalAspects', is_array( $data ) ? $data : array(), $atts );
	}
}
