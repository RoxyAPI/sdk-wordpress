<?php
/**
 * Auto-generated shortcode: [roxy_get_monthly_declination_parallels]
 *
...
class GetMonthlyDeclinationParallels {

	public const TAG = 'roxy_get_monthly_declination_parallels';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::getMonthlyDeclinationParallels( $body, $query );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render_atts( 'getMonthlyDeclinationParallels', is_array( $data ) ? $data : array(), $atts );
	}
}
