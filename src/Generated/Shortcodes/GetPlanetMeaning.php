<?php
/**
 * Auto-generated shortcode: [roxy_get_planet_meaning]
 *
...
class GetPlanetMeaning {
	...
	public const TAG = 'roxy_get_planet_meaning';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		return ComponentRenderer::render( 'getPlanetMeaning', is_array( $data ) ? $data : array(), $atts['hide_readings'], $atts['hide_sections'] );
	}
}
