<?php
/**
 * Auto-generated shortcode: [roxy_calculate_birth_day]
 *
...
class CalculateBirthDay {
	...
	public const TAG = 'roxy_calculate_birth_day';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::calculateBirthDay( $body, $query );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render( 'calculateBirthDay', is_array( $data ) ? $data : array(), $atts['hide_readings'], $atts['hide_sections'] );
	}
}
