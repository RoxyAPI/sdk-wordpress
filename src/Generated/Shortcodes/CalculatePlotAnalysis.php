<?php
/**
 * Auto-generated shortcode: [roxy_calculate_plot_analysis]
 *
...
class CalculatePlotAnalysis {

	public const TAG = 'roxy_calculate_plot_analysis';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		return FormRenderer::render( \RoxyAPI\Generated\Forms\CalculatePlotAnalysisForm::class, $atts );
	}
}
