<?php
/**
 * Auto-generated shortcode: [roxy_get_yoga]
 *
...
class GetYoga {
	...
	public const TAG = 'roxy_get_yoga';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		return ComponentRenderer::render( 'getYoga', is_array( $data ) ? $data : array(), $atts['hide_readings'], $atts['hide_sections'] );
	}
}
