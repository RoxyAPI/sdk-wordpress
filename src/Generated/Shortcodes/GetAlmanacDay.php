<?php
/**
 * Auto-generated shortcode: [roxy_get_almanac_day]
 *
...
class GetAlmanacDay {
	...
	public const TAG = 'roxy_get_almanac_day';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::getAlmanacDay( $atts['date'], $atts['lang'] );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render_atts( 'getAlmanacDay', is_array( $data ) ? $data : array(), $atts );
	}
}
