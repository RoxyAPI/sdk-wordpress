<?php
/**
 * Auto-generated shortcode: [roxy_get_dosha]
 *
...
class GetDosha {
	...
	public const TAG = 'roxy_get_dosha';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::getDosha( $atts['id'], $atts['lang'] );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render_atts( 'getDosha', is_array( $data ) ? $data : array(), $atts );
	}
}
