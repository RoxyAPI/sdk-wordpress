<?php
/**
 * Auto-generated shortcode: [roxy_check_sadhesati]
 *
...
class CheckSadhesati {
	...
	public const TAG = 'roxy_check_sadhesati';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::checkSadhesati( $body, $query );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render( 'checkSadhesati', is_array( $data ) ? $data : array(), $atts['hide_readings'], $atts['hide_sections'] );
	}
}
