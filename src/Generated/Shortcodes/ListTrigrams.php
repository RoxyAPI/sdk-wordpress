<?php
/**
 * Auto-generated shortcode: [roxy_list_trigrams]
 *
 * List all 8 trigrams
 *
...
class ListTrigrams {
	...
	public const TAG = 'roxy_list_trigrams';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		return ComponentRenderer::render( 'listTrigrams', is_array( $data ) ? $data : array(), $atts['hide_readings'], $atts['hide_sections'] );
	}
}
