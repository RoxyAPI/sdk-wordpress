<?php
/**
 * Auto-generated shortcode: [roxy_generate_birth_profile]
 *
...
class GenerateBirthProfile {

	public const TAG = 'roxy_generate_birth_profile';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		wp_enqueue_style( 'roxyapi-frontend' );
			...
			array(
				...
				'angelDating' => $atts['angel_dating'],
				'yearStart' => $atts['year_start'],
				'leapDayPolicy' => $atts['leap_day_policy'],
				'afterSunset' => $atts['after_sunset'] !== '' ? filter_var( $atts['after_sunset'], FILTER_VALIDATE_BOOLEAN ) : '',
			),
			static function ( $v ) {
				return $v !== '';
			}
		...
		$data = \RoxyAPI\Generated\Client::generateBirthProfile( $body, $query );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render_atts( 'generateBirthProfile', is_array( $data ) ? $data : array(), $atts );
	}
}
