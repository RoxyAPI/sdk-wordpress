<?php
/**
 * Auto-generated shortcode: [roxy_get_monthly_tropical_transits]
 *
...
class GetMonthlyTropicalTransits {

	public const TAG = 'roxy_get_monthly_tropical_transits';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::getMonthlyTropicalTransits( $body, $query );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render_atts( 'getMonthlyTropicalTransits', is_array( $data ) ? $data : array(), $atts );
	}
}
