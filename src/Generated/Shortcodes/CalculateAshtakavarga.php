<?php
/**
 * Auto-generated shortcode: [roxy_calculate_ashtakavarga]
 *
...
class CalculateAshtakavarga {
	...
	public const TAG = 'roxy_calculate_ashtakavarga';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::calculateAshtakavarga( $body );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::error( $data->get_error_message() );
		}

		return Renderer::render_generic( 'calculateAshtakavarga', is_array( $data ) ? $data : array() );
	}
}
