<?php
/**
 * Auto-generated shortcode: [roxy_check_kalsarpa_dosha]
 *
...
class CheckKalsarpaDosha {

	public const TAG = 'roxy_check_kalsarpa_dosha';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::checkKalsarpaDosha( $body, $query );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render( 'checkKalsarpaDosha', is_array( $data ) ? $data : array(), $atts['hide_readings'], $atts['hide_sections'] );
	}
}
