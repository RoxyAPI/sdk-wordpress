...
class CalculateBridgeNumbers {
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::calculateBridgeNumbers( $body, $query );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render( 'calculateBridgeNumbers', is_array( $data ) ? $data : array(), $atts['hide_readings'] );
	}
}
