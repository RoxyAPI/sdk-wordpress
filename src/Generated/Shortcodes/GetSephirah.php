<?php
/**
 * Auto-generated shortcode: [roxy_get_sephirah]
 *
...
class GetSephirah {
	...
	public const TAG = 'roxy_get_sephirah';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::getSephirah( $atts['id'], $atts['lang'], $atts['sephirot_system'], $atts['letter_attribution'] );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render_atts( 'getSephirah', is_array( $data ) ? $data : array(), $atts );
	}
}
