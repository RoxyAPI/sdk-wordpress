<?php
/**
 * Auto-generated shortcode: [roxy_get_zodiac_animal]
 *
...
class GetZodiacAnimal {

	public const TAG = 'roxy_get_zodiac_animal';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::getZodiacAnimal( $atts['id'], $atts['lang'] );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render_atts( 'getZodiacAnimal', is_array( $data ) ? $data : array(), $atts );
	}
}
