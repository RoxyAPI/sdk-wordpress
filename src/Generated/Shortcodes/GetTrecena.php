<?php
/**
 * Auto-generated shortcode: [roxy_get_trecena]
 *
...
class GetTrecena {
	...
	public const TAG = 'roxy_get_trecena';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::getTrecena( $atts['number'], $atts['lang'] );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render_atts( 'getTrecena', is_array( $data ) ? $data : array(), $atts );
	}
}
