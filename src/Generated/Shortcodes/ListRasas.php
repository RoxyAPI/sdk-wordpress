<?php
/**
 * Auto-generated shortcode: [roxy_list_rasas]
 *
...
class ListRasas {
	...
	public const TAG = 'roxy_list_rasas';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::listRasas( $atts['lang'], $atts['limit'], $atts['offset'] );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render_atts( 'listRasas', is_array( $data ) ? $data : array(), $atts );
	}
}
