<?php
/**
 * Auto-generated shortcode: [roxy_get_field_labels]
 *
...
class GetFieldLabels {

	public const TAG = 'roxy_get_field_labels';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::getFieldLabels( $atts['lang'] );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render_atts( 'getFieldLabels', is_array( $data ) ? $data : array(), $atts );
	}
}
