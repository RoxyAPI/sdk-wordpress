<?php
/**
 * Auto-generated shortcode: [roxy_get_daily_dream_symbol]
 *
...
class GetDailyDreamSymbol {
	...
	public const TAG = 'roxy_get_daily_dream_symbol';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::getDailyDreamSymbol( $body );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render( 'getDailyDreamSymbol', is_array( $data ) ? $data : array(), $atts['hide_readings'], $atts['hide_sections'] );
	}
}
