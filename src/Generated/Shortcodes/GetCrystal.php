<?php
/**
 * Auto-generated shortcode: [roxy_get_crystal]
 *
...
class GetCrystal {
	...
	public const TAG = 'roxy_get_crystal';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::getCrystal( $atts['id'], $atts['lang'] );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render( 'getCrystal', is_array( $data ) ? $data : array(), $atts['hide_readings'] );
	}
}
