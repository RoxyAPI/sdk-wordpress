<?php
/**
 * Auto-generated shortcode: [roxy_cast_celtic_cross]
 *
...
class CastCelticCross {
	...
	public const TAG = 'roxy_cast_celtic_cross';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::castCelticCross( $body, $query );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render( 'castCelticCross', is_array( $data ) ? $data : array(), $atts['hide_readings'], $atts['hide_sections'] );
	}
}
