<?php
/**
 * Auto-generated shortcode: [roxy_list_aztec_trecenas]
 *
...
class ListAztecTrecenas {

	public const TAG = 'roxy_list_aztec_trecenas';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::listAztecTrecenas( $atts['lang'], $atts['limit'], $atts['offset'] );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render_atts( 'listAztecTrecenas', is_array( $data ) ? $data : array(), $atts );
	}
}
