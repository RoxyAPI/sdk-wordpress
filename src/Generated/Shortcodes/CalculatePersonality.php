<?php
/**
 * Auto-generated shortcode: [roxy_calculate_personality]
 *
...
class CalculatePersonality {
	...
	public const TAG = 'roxy_calculate_personality';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::calculatePersonality( $body, $query );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render( 'calculatePersonality', is_array( $data ) ? $data : array(), $atts['hide_readings'], $atts['hide_sections'] );
	}
}
