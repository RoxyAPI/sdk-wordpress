<?php
/**
 * Auto-generated shortcode: [roxy_generate_local_space]
 *
...
class GenerateLocalSpace {
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		return ComponentRenderer::render( 'generateLocalSpace', is_array( $data ) ? $data : array(), $atts['hide_readings'] );
	}
}
