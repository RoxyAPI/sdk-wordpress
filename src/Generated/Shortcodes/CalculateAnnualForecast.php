<?php
/**
 * Auto-generated shortcode: [roxy_calculate_annual_forecast]
 *
...
class CalculateAnnualForecast {

	public const TAG = 'roxy_calculate_annual_forecast';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::calculateAnnualForecast( $body, $query );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render_atts( 'calculateAnnualForecast', is_array( $data ) ? $data : array(), $atts );
	}
}
