<?php
/**
 * Auto-generated shortcode: [roxy_generate_bazi_chart]
 *
...
class GenerateBaziChart {

	public const TAG = 'roxy_generate_bazi_chart';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::generateBaziChart( $body, $query );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render_atts( 'generateBaziChart', is_array( $data ) ? $data : array(), $atts );
	}
}
