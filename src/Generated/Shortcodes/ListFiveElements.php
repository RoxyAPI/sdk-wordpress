<?php
/**
 * Auto-generated shortcode: [roxy_list_five_elements]
 *
...
class ListFiveElements {

	public const TAG = 'roxy_list_five_elements';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::listFiveElements( $atts['lang'], $atts['limit'], $atts['offset'] );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render_atts( 'listFiveElements', is_array( $data ) ? $data : array(), $atts );
	}
}
