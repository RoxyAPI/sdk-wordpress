<?php
/**
 * Auto-generated shortcode: [roxy_generate_digest]
 *
...
class GenerateDigest {
	...
	public const TAG = 'roxy_generate_digest';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		return FormRenderer::render( \RoxyAPI\Generated\Forms\GenerateDigestForm::class, $atts );
	}
}
