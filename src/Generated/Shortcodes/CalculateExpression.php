<?php
/**
 * Auto-generated shortcode: [roxy_calculate_expression]
 *
...
class CalculateExpression {
	...
	public const TAG = 'roxy_calculate_expression';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::calculateExpression( $body, $query );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render( 'calculateExpression', is_array( $data ) ? $data : array(), $atts['hide_readings'], $atts['hide_sections'] );
	}
}
