<?php
/**
 * Auto-generated shortcode: [roxy_get_nakshatra]
 *
...
class GetNakshatra {
	...
	public const TAG = 'roxy_get_nakshatra';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::getNakshatra( $atts['id'], $atts['lang'] );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render( 'getNakshatra', is_array( $data ) ? $data : array(), $atts['hide_readings'], $atts['hide_sections'] );
	}
}
