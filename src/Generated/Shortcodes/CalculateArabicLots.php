<?php
/**
 * Auto-generated shortcode: [roxy_calculate_arabic_lots]
 *
...
class CalculateArabicLots {

	public const TAG = 'roxy_calculate_arabic_lots';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::calculateArabicLots( $body, $query );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render( 'calculateArabicLots', is_array( $data ) ? $data : array(), $atts['hide_readings'] );
	}
}
