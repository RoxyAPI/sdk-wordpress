<?php
/**
 * Auto-generated shortcode: [roxy_list_planet_meanings]
 *
...
class ListPlanetMeanings {
	...
	public const TAG = 'roxy_list_planet_meanings';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		return ComponentRenderer::render( 'listPlanetMeanings', is_array( $data ) ? $data : array(), $atts['hide_readings'], $atts['hide_sections'] );
	}
}
