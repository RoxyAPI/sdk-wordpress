<?php
/**
 * Auto-generated shortcode: [roxy_generate_asteroids]
 *
...
class GenerateAsteroids {
	...
	public const TAG = 'roxy_generate_asteroids';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::generateAsteroids( $body, $query );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render( 'generateAsteroids', is_array( $data ) ? $data : array(), $atts['hide_readings'], $atts['hide_sections'] );
	}
}
