<?php
/**
 * Auto-generated shortcode: [roxy_get_aztec_day_sign]
 *
...
class GetAztecDaySign {

	public const TAG = 'roxy_get_aztec_day_sign';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::getAztecDaySign( $atts['id'], $atts['lang'] );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render_atts( 'getAztecDaySign', is_array( $data ) ? $data : array(), $atts );
	}
}
