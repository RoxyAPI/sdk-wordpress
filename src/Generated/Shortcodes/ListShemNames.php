<?php
/**
 * Auto-generated shortcode: [roxy_list_shem_names]
 *
...
class ListShemNames {
	...
	public const TAG = 'roxy_list_shem_names';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::listShemNames( $atts['lang'], $atts['limit'], $atts['offset'], $atts['longitude'] );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render_atts( 'listShemNames', is_array( $data ) ? $data : array(), $atts );
	}
}
