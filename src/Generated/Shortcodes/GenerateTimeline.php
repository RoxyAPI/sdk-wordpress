<?php
/**
 * Auto-generated shortcode: [roxy_generate_timeline]
 *
...
class GenerateTimeline {
	...
	public const TAG = 'roxy_generate_timeline';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		return FormRenderer::render( \RoxyAPI\Generated\Forms\GenerateTimelineForm::class, $atts );
	}
}
