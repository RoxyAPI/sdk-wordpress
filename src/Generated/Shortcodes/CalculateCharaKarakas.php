<?php
/**
 * Auto-generated shortcode: [roxy_calculate_chara_karakas]
 *
...
class CalculateCharaKarakas {
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		return ComponentRenderer::render( 'calculateCharaKarakas', is_array( $data ) ? $data : array(), $atts['hide_readings'], $atts['hide_sections'] );
	}
}
