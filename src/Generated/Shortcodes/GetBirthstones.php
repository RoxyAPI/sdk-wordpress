<?php
/**
 * Auto-generated shortcode: [roxy_get_birthstones]
 *
...
class GetBirthstones {
	...
	public const TAG = 'roxy_get_birthstones';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::getBirthstones( $atts['month'], $atts['lang'] );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::error( $data->get_error_message() );
		}

		return Renderer::render_generic( 'getBirthstones', is_array( $data ) ? $data : array() );
	}
}
