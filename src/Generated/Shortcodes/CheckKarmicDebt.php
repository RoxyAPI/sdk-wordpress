<?php
/**
 * Auto-generated shortcode: [roxy_check_karmic_debt]
 *
...
class CheckKarmicDebt {
	...
	public const TAG = 'roxy_check_karmic_debt';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::checkKarmicDebt( $body, $query );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render( 'checkKarmicDebt', is_array( $data ) ? $data : array(), $atts['hide_readings'], $atts['hide_sections'] );
	}
}
