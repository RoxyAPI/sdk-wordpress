<?php
/**
 * Auto-generated shortcode: [roxy_list_hebrew_letters]
 *
...
class ListHebrewLetters {

	public const TAG = 'roxy_list_hebrew_letters';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::listHebrewLetters( $atts['lang'], $atts['letter_attribution'] );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render_atts( 'listHebrewLetters', is_array( $data ) ? $data : array(), $atts );
	}
}
