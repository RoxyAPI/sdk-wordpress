<?php
/**
 * Auto-generated shortcode: [roxy_get_monthly_aspects]
 *
...
class GetMonthlyAspects {

	public const TAG = 'roxy_get_monthly_aspects';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::getMonthlyAspects( $body, $query );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render( 'getMonthlyAspects', is_array( $data ) ? $data : array(), $atts['hide_readings'] );
	}
}
