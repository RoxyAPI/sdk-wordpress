<?php
/**
 * Auto-generated shortcode: [roxy_calculate_ayurvedic_constitution]
 *
...
class CalculateAyurvedicConstitution {

	public const TAG = 'roxy_calculate_ayurvedic_constitution';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		wp_enqueue_style( 'roxyapi-frontend' );
			...
			array(
				...
				'signDoshaScheme' => $atts['sign_dosha_scheme'],
			),
			static function ( $v ) {
				return $v !== '';
			}
		...
		$data = \RoxyAPI\Generated\Client::calculateAyurvedicConstitution( $body, $query );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render_atts( 'calculateAyurvedicConstitution', is_array( $data ) ? $data : array(), $atts );
	}
}
