<?php
/**
 * Auto-generated shortcode: [roxy_get_daily_crystal]
 *
 * Daily Crystal
 *
...
class GetDailyCrystal {
	...
	public const TAG = 'roxy_get_daily_crystal';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::getDailyCrystal( $body, $query );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render( 'getDailyCrystal', is_array( $data ) ? $data : array(), $atts['hide_readings'], $atts['hide_sections'] );
	}
}
