<?php
/**
 * Auto-generated shortcode: [roxy_calculate_variables]
 *
...
class CalculateVariables {
	...
	public const TAG = 'roxy_calculate_variables';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::calculateVariables( $body, $query );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render( 'calculateVariables', is_array( $data ) ? $data : array(), $atts['hide_readings'], $atts['hide_sections'] );
	}
}
