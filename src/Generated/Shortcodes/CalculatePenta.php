<?php
/**
 * Auto-generated shortcode: [roxy_calculate_penta]
 *
...
class CalculatePenta {

	public const TAG = 'roxy_calculate_penta';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		return FormRenderer::render( \RoxyAPI\Generated\Forms\CalculatePentaForm::class, $atts );
	}
}
