<?php
/**
 * Auto-generated shortcode: [roxy_list_flying_stars]
 *
...
class ListFlyingStars {

	public const TAG = 'roxy_list_flying_stars';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::listFlyingStars( $atts['lang'], $atts['limit'], $atts['offset'] );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render_atts( 'listFlyingStars', is_array( $data ) ? $data : array(), $atts );
	}
}
