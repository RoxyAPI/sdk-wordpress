<?php
/**
 * Auto-generated shortcode: [roxy_list_aztec_day_signs]
 *
...
class ListAztecDaySigns {

	public const TAG = 'roxy_list_aztec_day_signs';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::listAztecDaySigns( $atts['lang'], $atts['limit'], $atts['offset'] );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render_atts( 'listAztecDaySigns', is_array( $data ) ? $data : array(), $atts );
	}
}
