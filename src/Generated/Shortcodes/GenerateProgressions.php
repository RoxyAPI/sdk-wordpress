<?php
/**
 * Auto-generated shortcode: [roxy_generate_progressions]
 *
...
class GenerateProgressions {

	public const TAG = 'roxy_generate_progressions';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::generateProgressions( $body, $query );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render( 'generateProgressions', is_array( $data ) ? $data : array(), $atts['hide_readings'], $atts['hide_sections'] );
	}
}
