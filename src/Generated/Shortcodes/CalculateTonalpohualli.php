<?php
/**
 * Auto-generated shortcode: [roxy_calculate_tonalpohualli]
 *
...
class CalculateTonalpohualli {

	public const TAG = 'roxy_calculate_tonalpohualli';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::calculateTonalpohualli( $body, $query );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render_atts( 'calculateTonalpohualli', is_array( $data ) ? $data : array(), $atts );
	}
}
