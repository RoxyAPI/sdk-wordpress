<?php
/**
 * Auto-generated shortcode: [roxy_get_daily_aztec_reading]
 *
...
class GetDailyAztecReading {

	public const TAG = 'roxy_get_daily_aztec_reading';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::getDailyAztecReading( $atts['lang'], $atts['date'] );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render_atts( 'getDailyAztecReading', is_array( $data ) ? $data : array(), $atts );
	}
}
