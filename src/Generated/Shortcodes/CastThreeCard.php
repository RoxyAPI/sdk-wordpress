<?php
/**
 * Auto-generated shortcode: [roxy_cast_three_card]
 *
...
class CastThreeCard {
	...
	public const TAG = 'roxy_cast_three_card';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::castThreeCard( $body, $query );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render( 'castThreeCard', is_array( $data ) ? $data : array(), $atts['hide_readings'], $atts['hide_sections'] );
	}
}
