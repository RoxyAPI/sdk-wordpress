<?php
/**
 * Auto-generated shortcode: [roxy_list_zodiac_animals]
 *
...
class ListZodiacAnimals {

	public const TAG = 'roxy_list_zodiac_animals';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::listZodiacAnimals( $atts['lang'], $atts['limit'], $atts['offset'] );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render_atts( 'listZodiacAnimals', is_array( $data ) ? $data : array(), $atts );
	}
}
