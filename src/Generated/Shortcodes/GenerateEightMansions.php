<?php
/**
 * Auto-generated shortcode: [roxy_generate_eight_mansions]
 *
...
class GenerateEightMansions {

	public const TAG = 'roxy_generate_eight_mansions';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::generateEightMansions( $body, $query );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render_atts( 'generateEightMansions', is_array( $data ) ? $data : array(), $atts );
	}
}
