<?php
/**
 * Auto-generated shortcode: [roxy_calculate_entrance_pada]
 *
...
class CalculateEntrancePada {

	public const TAG = 'roxy_calculate_entrance_pada';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		return FormRenderer::render( \RoxyAPI\Generated\Forms\CalculateEntrancePadaForm::class, $atts );
	}
}
