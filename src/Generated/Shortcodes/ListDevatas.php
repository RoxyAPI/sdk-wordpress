<?php
/**
 * Auto-generated shortcode: [roxy_list_devatas]
 *
...
class ListDevatas {
	...
	public const TAG = 'roxy_list_devatas';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::listDevatas( $atts['lang'], $atts['limit'], $atts['offset'] );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render_atts( 'listDevatas', is_array( $data ) ? $data : array(), $atts );
	}
}
