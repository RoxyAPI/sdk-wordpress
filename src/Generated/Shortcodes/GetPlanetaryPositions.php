<?php
/**
 * Auto-generated shortcode: [roxy_get_planetary_positions]
 *
...
class GetPlanetaryPositions {

	public const TAG = 'roxy_get_planetary_positions';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::getPlanetaryPositions( $body, $query );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render( 'getPlanetaryPositions', is_array( $data ) ? $data : array(), $atts['hide_readings'], $atts['hide_sections'] );
	}
}
