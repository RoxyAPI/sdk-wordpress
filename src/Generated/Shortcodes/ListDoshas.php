<?php
/**
 * Auto-generated shortcode: [roxy_list_doshas]
 *
...
class ListDoshas {
	...
	public const TAG = 'roxy_list_doshas';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::listDoshas( $atts['lang'], $atts['limit'], $atts['offset'] );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render_atts( 'listDoshas', is_array( $data ) ? $data : array(), $atts );
	}
}
