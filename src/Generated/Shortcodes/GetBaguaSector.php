<?php
/**
 * Auto-generated shortcode: [roxy_get_bagua_sector]
 *
...
class GetBaguaSector {

	public const TAG = 'roxy_get_bagua_sector';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::getBaguaSector( $atts['id'], $atts['lang'] );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render_atts( 'getBaguaSector', is_array( $data ) ? $data : array(), $atts );
	}
}
