<?php
/**
 * Auto-generated shortcode: [roxy_list_dikpala_directions]
 *
...
class ListDikpalaDirections {

	public const TAG = 'roxy_list_dikpala_directions';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::listDikpalaDirections( $atts['lang'], $atts['limit'], $atts['offset'] );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render_atts( 'listDikpalaDirections', is_array( $data ) ? $data : array(), $atts );
	}
}
