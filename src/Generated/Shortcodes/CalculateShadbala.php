<?php
/**
 * Auto-generated shortcode: [roxy_calculate_shadbala]
 *
...
class CalculateShadbala {
	...
	public const TAG = 'roxy_calculate_shadbala';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::calculateShadbala( $body, $query );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render( 'calculateShadbala', is_array( $data ) ? $data : array(), $atts['hide_readings'] );
	}
}
