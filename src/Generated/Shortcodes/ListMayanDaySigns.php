<?php
/**
 * Auto-generated shortcode: [roxy_list_mayan_day_signs]
 *
...
class ListMayanDaySigns {

	public const TAG = 'roxy_list_mayan_day_signs';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::listMayanDaySigns( $atts['lang'], $atts['direction_scheme'], $atts['limit'], $atts['offset'] );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render_atts( 'listMayanDaySigns', is_array( $data ) ? $data : array(), $atts );
	}
}
