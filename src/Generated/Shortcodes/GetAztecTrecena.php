<?php
/**
 * Auto-generated shortcode: [roxy_get_aztec_trecena]
 *
...
class GetAztecTrecena {

	public const TAG = 'roxy_get_aztec_trecena';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::getAztecTrecena( $atts['number'], $atts['lang'] );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render_atts( 'getAztecTrecena', is_array( $data ) ? $data : array(), $atts );
	}
}
