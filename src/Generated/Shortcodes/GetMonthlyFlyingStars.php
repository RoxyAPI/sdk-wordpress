<?php
/**
 * Auto-generated shortcode: [roxy_get_monthly_flying_stars]
 *
...
class GetMonthlyFlyingStars {

	public const TAG = 'roxy_get_monthly_flying_stars';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::getMonthlyFlyingStars( $atts['lang'], $atts['year'], $atts['month'] );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render_atts( 'getMonthlyFlyingStars', is_array( $data ) ? $data : array(), $atts );
	}
}
