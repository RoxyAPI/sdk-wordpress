<?php
/**
 * Auto-generated shortcode: [roxy_detect_yogas]
 *
...
class DetectYogas {
	...
	public const TAG = 'roxy_detect_yogas';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::detectYogas( $body, $query );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render( 'detectYogas', is_array( $data ) ? $data : array(), $atts['hide_readings'] );
	}
}
