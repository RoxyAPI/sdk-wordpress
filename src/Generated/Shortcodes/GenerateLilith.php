<?php
/**
 * Auto-generated shortcode: [roxy_generate_lilith]
 *
...
class GenerateLilith {

	public const TAG = 'roxy_generate_lilith';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::generateLilith( $body, $query );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render( 'generateLilith', is_array( $data ) ? $data : array(), $atts['hide_readings'], $atts['hide_sections'] );
	}
}
