<?php
/**
 * Auto-generated shortcode: [roxy_calculate_luck_pillars]
 *
...
class CalculateLuckPillars {

	public const TAG = 'roxy_calculate_luck_pillars';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		wp_enqueue_style( 'roxyapi-frontend' );
			...
			array(
				...
				'annualFromYear' => $atts['annual_from_year'] !== '' ? (int) $atts['annual_from_year'] : '',
				'annualYears' => $atts['annual_years'] !== '' ? (int) $atts['annual_years'] : '',
			),
			static function ( $v ) {
				return $v !== '';
			}
		...
		$data = \RoxyAPI\Generated\Client::calculateLuckPillars( $body, $query );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render_atts( 'calculateLuckPillars', is_array( $data ) ? $data : array(), $atts );
	}
}
