<?php
/**
 * Auto-generated shortcode: [roxy_list_crystal_colors]
 *
 * List Crystal Colors
 *
...
class ListCrystalColors {
	...
	public const TAG = 'roxy_list_crystal_colors';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::listCrystalColors(  );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render( 'listCrystalColors', is_array( $data ) ? $data : array(), $atts['hide_readings'], $atts['hide_sections'] );
	}
}
