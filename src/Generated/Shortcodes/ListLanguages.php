<?php
/**
 * Auto-generated shortcode: [roxy_list_languages]
 *
...
class ListLanguages {
	...
	public const TAG = 'roxy_list_languages';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::listLanguages(  );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render( 'listLanguages', is_array( $data ) ? $data : array(), $atts['hide_readings'], $atts['hide_sections'] );
	}
}
