<?php
/**
 * Auto-generated shortcode: [roxy_get_usage_stats]
 *
...
class GetUsageStats {
	...
	public const TAG = 'roxy_get_usage_stats';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		return ComponentRenderer::render( 'getUsageStats', is_array( $data ) ? $data : array(), $atts['hide_readings'] );
	}
}
