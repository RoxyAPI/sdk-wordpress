<?php
/**
 * Auto-generated shortcode: [roxy_list_haab_months]
 *
...
class ListHaabMonths {

	public const TAG = 'roxy_list_haab_months';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::listHaabMonths( $atts['lang'], $atts['limit'], $atts['offset'] );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render_atts( 'listHaabMonths', is_array( $data ) ? $data : array(), $atts );
	}
}
