<?php
/**
 * Auto-generated shortcode: [roxy_calculate_dashakoot]
 *
...
class CalculateDashakoot {

	public const TAG = 'roxy_calculate_dashakoot';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		return FormRenderer::render( \RoxyAPI\Generated\Forms\CalculateDashakootForm::class, $atts );
	}
}
