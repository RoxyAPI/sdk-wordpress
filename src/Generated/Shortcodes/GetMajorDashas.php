<?php
/**
 * Auto-generated shortcode: [roxy_get_major_dashas]
 *
...
class GetMajorDashas {
	...
	public const TAG = 'roxy_get_major_dashas';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::getMajorDashas( $body, $query );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render( 'getMajorDashas', is_array( $data ) ? $data : array(), $atts['hide_readings'], $atts['hide_sections'] );
	}
}
