<?php
/**
 * Auto-generated shortcode: [roxy_get_gate]
 *
...
class GetGate {
	...
	public const TAG = 'roxy_get_gate';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::getGate( $atts['number'], $atts['lang'] );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render( 'getGate', is_array( $data ) ? $data : array(), $atts['hide_readings'] );
	}
}
