<?php
/**
 * Auto-generated shortcode: [roxy_generate_mandala]
 *
...
class GenerateMandala {

	public const TAG = 'roxy_generate_mandala';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		return FormRenderer::render( \RoxyAPI\Generated\Forms\GenerateMandalaForm::class, $atts );
	}
}
