<?php
/**
 * Auto-generated shortcode: [roxy_list_gunas]
 *
...
class ListGunas {
	...
	public const TAG = 'roxy_list_gunas';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::listGunas( $atts['lang'], $atts['limit'], $atts['offset'] );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render_atts( 'listGunas', is_array( $data ) ? $data : array(), $atts );
	}
}
