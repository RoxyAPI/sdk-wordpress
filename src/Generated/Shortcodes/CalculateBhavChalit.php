<?php
/**
 * Auto-generated shortcode: [roxy_calculate_bhav_chalit]
 *
...
class CalculateBhavChalit {

	public const TAG = 'roxy_calculate_bhav_chalit';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::calculateBhavChalit( $body, $query );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render( 'calculateBhavChalit', is_array( $data ) ? $data : array(), $atts['hide_readings'], $atts['hide_sections'] );
	}
}
