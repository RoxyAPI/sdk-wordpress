<?php
/**
 * Auto-generated shortcode: [roxy_calculate_room_compliance]
 *
...
class CalculateRoomCompliance {

	public const TAG = 'roxy_calculate_room_compliance';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		return FormRenderer::render( \RoxyAPI\Generated\Forms\CalculateRoomComplianceForm::class, $atts );
	}
}
