<?php
/**
 * Auto-generated shortcode: [roxy_calculate_tzolkin]
 *
...
class CalculateTzolkin {

	public const TAG = 'roxy_calculate_tzolkin';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::calculateTzolkin( $body, $query );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render_atts( 'calculateTzolkin', is_array( $data ) ? $data : array(), $atts );
	}
}
