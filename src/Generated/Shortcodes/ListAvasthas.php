<?php
/**
 * Auto-generated shortcode: [roxy_list_avasthas]
 *
...
class ListAvasthas {
	...
	public const TAG = 'roxy_list_avasthas';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::listAvasthas( $atts['lang'], $atts['system'] );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render( 'listAvasthas', is_array( $data ) ? $data : array(), $atts['hide_readings'], $atts['hide_sections'] );
	}
}
