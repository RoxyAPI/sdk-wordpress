<?php
/**
 * Auto-generated shortcode: [roxy_calculate_zodiac_animal]
 *
...
class CalculateZodiacAnimal {

	public const TAG = 'roxy_calculate_zodiac_animal';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::calculateZodiacAnimal( $body, $query );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render_atts( 'calculateZodiacAnimal', is_array( $data ) ? $data : array(), $atts );
	}
}
