<?php
/**
 * Auto-generated shortcode: [roxy_list_bagua_sectors]
 *
...
class ListBaguaSectors {

	public const TAG = 'roxy_list_bagua_sectors';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::listBaguaSectors( $atts['lang'], $atts['limit'], $atts['offset'] );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render_atts( 'listBaguaSectors', is_array( $data ) ? $data : array(), $atts );
	}
}
