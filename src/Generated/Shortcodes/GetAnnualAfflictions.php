<?php
/**
 * Auto-generated shortcode: [roxy_get_annual_afflictions]
 *
...
class GetAnnualAfflictions {

	public const TAG = 'roxy_get_annual_afflictions';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::getAnnualAfflictions( $atts['year'], $atts['lang'] );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render_atts( 'getAnnualAfflictions', is_array( $data ) ? $data : array(), $atts );
	}
}
