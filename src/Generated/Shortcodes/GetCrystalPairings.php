<?php
/**
 * Auto-generated shortcode: [roxy_get_crystal_pairings]
 *
 * Crystal Pairings
 *
...
class GetCrystalPairings {

	public const TAG = 'roxy_get_crystal_pairings';
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::getCrystalPairings( $atts['id'], $atts['lang'] );

		if ( is_wp_error( $data ) ) {
			return \RoxyAPI\Support\Templates::api_error( $data );
		}

		return ComponentRenderer::render( 'getCrystalPairings', is_array( $data ) ? $data : array(), $atts['hide_readings'], $atts['hide_sections'] );
	}
}
