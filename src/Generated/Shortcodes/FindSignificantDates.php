<?php
/**
 * Auto-generated shortcode: [roxy_find_significant_dates]
 *
...
class FindSignificantDates {
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		return FormRenderer::render( \RoxyAPI\Generated\Forms\FindSignificantDatesForm::class, $atts );
	}
}
