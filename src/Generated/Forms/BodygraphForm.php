<?php
/**
 * Auto-generated visitor form for the [roxy_bodygraph] hero shortcode.
 *
...
class BodygraphForm {
	...
	public static function spec(): array {
		return array(
			'operation_id' => 'bodygraph',
			'render_operation_id' => 'generateBodygraph',
			'title'        => __( 'Human Design bodygraph', 'roxyapi' ),
			'submit_label' => __( 'Generate bodygraph', 'roxyapi' ),
			'sections'     => array(
			array(
				'name'   => 'birth',
	...
	public static function call( array $body ) {
		...
		return \RoxyAPI\Generated\Heroes\Bodygraph::fetch_for_form( $atts );
	}
}
