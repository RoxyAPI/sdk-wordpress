...
class FindSignificantDatesForm {
	...
	public static function spec(): array {
		return array(
			...
			'title'        => 'Significant dates - High-significance cross-domain forecast highlights',
			...
			'flat_fields'  => array(
				array(
					...
					'label' => 'Start date',
					'required' => false,
					'help' => 'First day of the window in YYYY-MM-DD format',
					'type' => 'date',
				),
				array(
					'name' => 'endDate',
					'label' => 'End date',
					'required' => false,
					'help' => 'Last day of the window in YYYY-MM-DD format',
					'type' => 'date',
				),
				array(
					...
					'required' => false,
					'help' => 'Significance floor from 0 to 100 for what counts as a significant date',
					'type' => 'number',
					'min' => 0,
					'max' => 100,
					'step' => 'any',
