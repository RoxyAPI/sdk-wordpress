<?php
/**
 * Auto-generated visitor form for findSignificantDates.
 *
...
class FindSignificantDatesForm {
		...
		return array(
			...
			'flat_fields'  => array(
				array(
					...
					'required' => false,
					'help' => __( 'First day of the window in YYYY-MM-DD format', 'roxyapi' ),
					'type' => 'date',
				),
				array(
					'name' => 'endDate',
					...
					'required' => false,
					'help' => __( 'Last day of the window in YYYY-MM-DD format', 'roxyapi' ),
					'type' => 'date',
				),
				array(
					...
					'required' => false,
					'help' => __( 'Significance floor from 0 to 100 for what counts as a significant date', 'roxyapi' ),
					'type' => 'number',
					'min' => 0,
					'max' => 100,
					'step' => 'any',
	...
	public static function call( array $body ) {
		return \RoxyAPI\Generated\Client::findSignificantDates( $body );
	}
}
