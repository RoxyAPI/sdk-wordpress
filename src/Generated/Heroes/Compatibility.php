<?php
/**
 * Auto-generated hero shortcode: [roxy_compatibility]
 *
 * Western compatibility percentage between two charts with sign, element, and aspect breakdown.
 *
 * Form-only hero. Delegates rendering to the existing long-tail Form
 * class \RoxyAPI\Generated\Forms\CalculateCompatibilityForm, which already
...
class Compatibility {
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		return \RoxyAPI\Support\FormRenderer::render( \RoxyAPI\Generated\Forms\CalculateCompatibilityForm::class, $atts );
	}
}
