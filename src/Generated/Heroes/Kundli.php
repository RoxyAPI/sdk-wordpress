<?php
/**
 * Auto-generated hero shortcode: [roxy_kundli]
 *
 * Vedic birth chart with twelve rashis, planetary positions, nakshatra, and per-house interpretations.
 *
 * Example: [roxy_kundli birth_date="1990-05-15" birth_time="14:30" lat="28.6139" lon="77.2090" tz="Asia/Kolkata"]
 *
...
class Kundli {
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		$data = \RoxyAPI\Generated\Client::generateBirthChart( array(
	...
	public static function fetch_for_form( array $atts ) {
		...
		if ( $atts['birth_date'] === '' || $atts['birth_time'] === '' || $atts['lat'] === '' || $atts['lon'] === '' ) {
			return new \WP_Error( 'roxyapi_missing_attrs', sprintf( /* translators: %s is the canonical example shortcode. */ __( "The birth_date, birth_time, lat, and lon attributes are required (tz defaults to 5.5 IST; pass an IANA name like Asia/Kolkata for DST-correct results). Example: %s", 'roxyapi' ), "[roxy_kundli birth_date=\"1990-05-15\" birth_time=\"14:30\" lat=\"28.6139\" lon=\"77.2090\" tz=\"Asia/Kolkata\"]" ) );
		}
