<?php
/**
 * Auto-generated hero shortcode: [roxy_kp_chart]
 *
 * Krishnamurti Paddhati chart with cusps, planets, sub-lords, and significators.
 *
 * Example: [roxy_kp_chart birth_date="1990-05-15" birth_time="14:30" lat="28.6139" lon="77.2090" tz="Asia/Kolkata"]
 *
...
class KpChart {
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		if ( $atts['mode'] === 'form' ) {
			return \RoxyAPI\Support\FormRenderer::render( \RoxyAPI\Generated\Forms\KpChartForm::class );
		}
		...
		if ( $atts['birth_date'] === '' || $atts['birth_time'] === '' || $atts['lat'] === '' || $atts['lon'] === '' ) {
			...
			return \RoxyAPI\Support\Templates::error( sprintf( /* translators: %s is the canonical example shortcode. */ __( "The birth_date, birth_time, lat, and lon attributes are required (tz defaults to 5.5 IST). Example: %s", 'roxyapi' ), "[roxy_kp_chart birth_date=\"1990-05-15\" birth_time=\"14:30\" lat=\"28.6139\" lon=\"77.2090\" tz=\"Asia/Kolkata\"]" ) );
		}
		...
		$data = \RoxyAPI\Generated\Client::generateKpChart( array(
		...
		return \RoxyAPI\Support\ComponentRenderer::render( 'generateKpChart', is_array( $data ) ? $data : array(), $atts['hide_readings'], $atts['hide_sections'] );
	}
	...
	public static function fetch_for_form( array $atts ) {
		...
		if ( $atts['birth_date'] === '' || $atts['birth_time'] === '' || $atts['lat'] === '' || $atts['lon'] === '' ) {
			return new \WP_Error( 'roxyapi_missing_attrs', sprintf( /* translators: %s is the canonical example shortcode. */ __( "The birth_date, birth_time, lat, and lon attributes are required (tz defaults to 5.5 IST). Example: %s", 'roxyapi' ), "[roxy_kp_chart birth_date=\"1990-05-15\" birth_time=\"14:30\" lat=\"28.6139\" lon=\"77.2090\" tz=\"Asia/Kolkata\"]" ) );
		}
