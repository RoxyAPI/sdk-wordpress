...
class KpChart {
	...
	public static function render( $atts, $content = '', $tag = '' ): string {
		...
		if ( $atts['mode'] === 'form' ) {
			return \RoxyAPI\Support\FormRenderer::render( \RoxyAPI\Generated\Forms\KpChartForm::class, $atts );
		}
		...
		return \RoxyAPI\Support\ComponentRenderer::render_atts( 'generateKpChart', is_array( $data ) ? $data : array(), $atts );
	}
